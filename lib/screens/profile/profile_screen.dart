...
class ProfileScreen extends StatelessWidget {
                        ...
                        children: [
                          Expanded(
                            child: _buildStatCard(
                              ...
                              value: gardenProvider.userPlants.length.toString(),
                              label: Translations.get(Translations.plants, lang),
                            ),
                          ),
                          SizedBox(width: 12),
                          Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildMenuCard(
                      ...
                      subtitle: '${gardenProvider.userPlants.length} ${Translations.get(Translations.activePlants, lang)}',
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                    ...
                    _buildMenuCard(
                      ...
                      subtitle: Translations.get(Translations.manageNotifications, lang),
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                    ...
                    _buildMenuCard(
                      ...
                      subtitle: '${Translations.get(Translations.version, lang)} 1.0.0',
                      onTap: () {
  ...
  void _showLogoutConfirmation(BuildContext context, AuthProvider authProvider, String lang) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        ...
        content: Text(Translations.get(Translations.logoutConfirmMessage, lang)),
        actions: [
          TextButton(
        ...
        content: Column(
          ...
          children: [
            ListTile(
              ...
              trailing: lang == 'id' ? Icon(Icons.check, color: Color(0xFF2ECC71)) : null,
              onTap: () async {
            ...
            ListTile(
              leading: Text('🇬🇧', style: TextStyle(fontSize: 24)),
              title: Text('English'),
              trailing: lang == 'en' ? Icon(Icons.check, color: Color(0xFF2ECC71)) : null,
              onTap: () async {
